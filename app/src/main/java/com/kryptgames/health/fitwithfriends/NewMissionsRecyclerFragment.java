...
import com.kryptgames.health.fitwithfriends.activity.RewardsActivity;
...
public class NewMissionsRecyclerFragment extends Fragment {
    ...
    public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewHolder>{
        ...
        public void onBindViewHolder(@NonNull RecyclerViewHolder holder, int position) {
            ...
            holder.frnds.setText(detailsList.get(position).duration);
            holder.days.setText(detailsList.get(position).group);
