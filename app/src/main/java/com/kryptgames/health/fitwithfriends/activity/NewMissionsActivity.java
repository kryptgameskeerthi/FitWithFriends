...
import com.kryptgames.health.fitwithfriends.NewMissionsRecyclerFragment;
import com.kryptgames.health.fitwithfriends.R;

public class NewMissionsActivity extends AppCompatActivity {
    ...
    protected Fragment createFragment() {
        return new NewMissionsRecyclerFragment().newInstance();
